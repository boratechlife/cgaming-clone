const WorksSection = () => {
  return (
    <div
      className="place-content-center items-center flex flex-col gap-[113px] h-min overflow-visible p-[100px_60px_30px] relative scroll-mt-[40px] w-full md:order-1 md:p-[123px_32px] sm:p-[97px_20px] 2xl:order-1 2xl:p-[170px_20px_40px]"
    ...
    >
      <div
        className="place-content-center items-start items-center flex flex-col gap-[80px] h-min max-w-[1280px] overflow-visible p-[0_60px] relative w-full md:max-w-none"
