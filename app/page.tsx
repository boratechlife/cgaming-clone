...
const awardsFAQData: any[] = [
  {
    ...
    answer: (
      <span>
        What began as an industry-focused initiative has grown into its sixth
        edition as a national celebration of Canadian games. The Canadian Game
        Awards (CGA) recognize and highlight Canada’s position on the global
        stage as a leader in interactive entertainment, bringing together
        developers, creators, esports professionals, and the wider gaming
        community.{" "}
        <a
          href="https://ivory-dogfish-302791.hostingersite.com/about"
          target="_blank"
          rel="noopener noreferrer"
          className="text-blue-400 hover:underline"
        >
          Learn more about CGA's story and mission.
        </a>
      </span>
    ),
    isOpen: true,
  ...
  },
  {
    ...
    answer: (
      <span>
        The Eh! Game Showcase is open and free for all attendees, offering an
        opportunity to play and explore Canadian-made games during the day. The
        Canadian Game Awards ceremony is a ticketed, in-person event with a
        limited number of seats available. It is designed to bring fans and
        industry professionals together in a shared celebration. For fans
        worldwide, the full ceremony will also be available to{" "}
        <a
          href="https://twitch.tv/canadiangameawards"
          target="_blank"
          rel="noopener noreferrer"
          className="text-blue-400 hover:underline"
        >
          stream online via Twitch
        </a>
      </span>
    ),
    isOpen: false,
...
export default function Home() {
  return (
    <section className="bg-gradient-to-b from-[#5630bf] via-[#3c2185] to-[#0d021b]">
      <HeroVideo />
